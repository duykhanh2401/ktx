...
const renderContract = async () => {
	...
	const BuildPage = async () => {
		...
		// 	search = '';
		// }
		const { data } = await (0,_util_fetchAPI__WEBPACK_IMPORTED_MODULE_0__.getDataAPI)(`contract/student`);
...
const renderLogin = async () => {
	...
	form.addEventListener('submit', async (e) => {
		...
		try {
			const isSuccess = await (0,_util_fetchAPI__WEBPACK_IMPORTED_MODULE_0__.postDataAPI)('student/login', {
				studentID,
				password,
			});
...
const renderRoom = async () => {
	...
	const BuildPage = async () => {
		...
		// 	search = '';
		// }
		const { data } = await (0,_util_fetchAPI__WEBPACK_IMPORTED_MODULE_0__.getDataAPI)(`room/student`);
...
"use strict";
/*!************************************!*\
  !*** ./public/js/student/index.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _login__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login */ "./public/js/student/login.js");
...
$(document).ready(function () {
	...
	if (contract) {
		(0,_contract__WEBPACK_IMPORTED_MODULE_1__.renderContract)();
	}
