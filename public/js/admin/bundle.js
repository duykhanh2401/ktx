...
*/
(function(Y,K){ true&&module.exports?(K["default"]=K,module.exports=Y.document?K(Y):K): true?!(__WEBPACK_AMD_DEFINE_RESULT__ = (function(){return K(Y)}).call(exports, __webpack_require__, exports, module),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)):(0)})("undefined"!==typeof window?window:this,function(Y){function K(f,e,l,C){f.hasOwnProperty(e)||(f[e]=C.apply(null,l),"function"===typeof CustomEvent&&Y.dispatchEvent(new CustomEvent("HighchartsModuleLoaded",{detail:{path:e,module:f[e]}})))}
...
const renderDashboard = async () => {
	const renderInvoice = async (month, year) => {
		const { data } = await (0,_util_fetchAPI__WEBPACK_IMPORTED_MODULE_1__.postDataAPI)('invoice/data-dashboard', {
			month,
			year,
		});
		let ax = [],
		...
		highcharts__WEBPACK_IMPORTED_MODULE_0___default().chart('invoiceDashboard', {
			title: {
	...
	const renderContract = async () => {
		const { data } = await (0,_util_fetchAPI__WEBPACK_IMPORTED_MODULE_1__.postDataAPI)('contract/data-dashboard');
		const dataRender = [];
		...
		highcharts__WEBPACK_IMPORTED_MODULE_0___default().chart('contractDashboard', {
			chart: {
...
/* harmony import */ var _dashboard__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./dashboard */ "./public/js/admin/dashboard.js");
/* harmony import */ var _util_fetchAPI__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./../util/fetchAPI */ "./public/js/util/fetchAPI.js");
...
$(document).ready(function () {
	...
	if (!login) {
		document
			...
			.addEventListener('click', async () => {
				const res = await (0,_util_fetchAPI__WEBPACK_IMPORTED_MODULE_10__.getDataAPI)('auth/admin/logout');
	...
	if (dashboard) {
		(0,_dashboard__WEBPACK_IMPORTED_MODULE_9__.renderDashboard)();
	}
});
